        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.users.index') }}" class="text-decoration-none text-info">Users</a></li>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.users.update', $user) }}">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary py-2 create-btn flex-grow-1">
